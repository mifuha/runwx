...
and weather coverage. The next milestone uses real historical race and weather
snapshots for a comparison between suitable editions through BigQuery and dbt.
